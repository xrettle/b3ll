...
import { Schedule as ScheduleType, getCurrentDaySchedule, schedules } from '../src/data/schedules'
import { InfoButton } from '../src/components/InfoPanel'
...
const Schedule = dynamic(() => import('../src/components/Schedule'), {
  ssr: false,
  loading: () => (
...
const SettingsPanel = dynamic(() => import('../src/components/SettingsPanel').then(mod => ({ default: mod.SettingsPanel })), {
  ssr: false,
...
const InfoPanel = dynamic(() => import('../src/components/InfoPanel').then(mod => ({ default: mod.InfoPanel })), {
  ssr: false,
  loading: () => null
})
